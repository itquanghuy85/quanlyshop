...
**Build Status:** ✅ `flutter build apk --debug` OK, đã cài + test trên Oppo CPH2203 (`m@m.com`/shop "M") — xem `[2026-08-29f]`, `[2026-08-29e]`, `[2026-08-29d]`, `[2026-08-29c]`, `[2026-08-29b]`, `[2026-08-29a]`, `[2026-08-24q]`, `[2026-08-24p]`, `[2026-08-24o]`, `[2026-08-24n]`, `[2026-08-24m]`, `[2026-08-24l]`, `[2026-08-24k]`, `[2026-08-24j]`, `[2026-08-24i]`, `[2026-08-24h]`, `[2026-08-24g]`, `[2026-08-24f]`, `[2026-08-24e]`, `[2026-08-24d]`, `[2026-08-24c]`, `[2026-08-24b]`, `[2026-08-24a]`, `[2026-08-23d]`, `[2026-08-23c]`, `[2026-08-23b]`, `[2026-08-23a]`, `[2026-08-22a]`  
...
&nbsp;&nbsp;• **Còn:** **1.3** chặn đơn CÔNG NỢ giá 0 + tự khớp `debt.totalAmount`; **1.4** `updateDebtPaid` khớp theo `firestoreId` + status HOA + không cộng đôi; **1.5** routine dọn 3 orphan cũ (12.8tr) + vá `debt_1787034406889` (`totalAmount=0`).
&nbsp;&nbsp;• **PHASE 2** (chờ user chốt mô hình): accrual vs cash basis, bỏ cap COGS (`min(cost, paid)` giấu lỗ), `financial_activity_log.balanceAfter*` NULL.
