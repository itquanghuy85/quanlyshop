...
**Version:** 3.5.0+550 (đóng gói lên store — `[2026-08-29e..s]` + `[2026-08-30a]`; 3.4.0+545 đang live). AAB build lại ở +550 để gồm đợt E2E bán hàng `[2026-08-30a]` (2 fix). Các build +546..+549 chưa upload store → bỏ, dùng +550.  
