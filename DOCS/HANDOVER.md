...
**📌 TỒN ĐỌNG NGHIỆM THU MÁY THẬT — CHƯA LÀM (rà 2026-09-05):** vẫn còn một danh sách dài các đợt cũ ghi "chưa nghiệm thu adb/máy thật" mà tới nay chưa chạy: `[2026-08-31c]` badge sync ảo · `[2026-08-31a]` "Đã giao" là trạng thái cuối (**cần 2 máy**) · `[2026-08-30w]` điều hướng Bảng giá/Đối soát · `[2026-08-30v]` Bảng giá P3 · `[2026-08-30u]` thẻ giá niêm yết trong form tạo đơn · `[2026-08-30s]` **nút ghi của Đối soát tiền về** (trước kẹt IME — nay nên kích được) · `[2026-08-30b]`, `[2026-08-29g]` · `[2026-08-24f]`/`[2026-08-23a]` đồng bộ 2 thiết bị + phương thức Chuyển khoản (**cần 2 máy**) · `[2026-08-22a]` quét QR bằng app ngân hàng thật · `[2026-08-16f]` luồng super admin · `[2026-08-08b]` Samsung A32. Trong phiên 2026-09-05 chỉ nghiệm thu phần việc CỦA PHIÊN + món crash trên. Máy thứ 2 (CPH2239) pin 3% nên các mục "cần 2 máy" chưa chạy được.  
