...
**Build Status:** ✅ `flutter build apk --debug` OK, đã cài + test trên Oppo CPH2203 (`m@m.com`/shop "M") — xem `[2026-08-24j]`, `[2026-08-24i]`, `[2026-08-24h]`, `[2026-08-24g]`, `[2026-08-24f]`, `[2026-08-24e]`, `[2026-08-24d]`, `[2026-08-24c]`, `[2026-08-24b]`, `[2026-08-24a]`, `[2026-08-23d]`, `[2026-08-23c]`, `[2026-08-23b]`, `[2026-08-23a]`, `[2026-08-22a]`  
...
**Branch:** master  
**🟡 CẦN USER QUYẾT ĐỊNH — lệch số "Còn nợ" NCC vs "Công nợ" (2026-08-24j):** rà soát ảnh user gửi phát hiện phiếu NK-0075 (10 triệu) bị lệch giữa tab Thống kê (tính là chưa trả) và tab Công nợ (khoản nợ liên kết đã đánh dấu trả đủ từ trước) — gốc rễ do `PaymentIntentService` (xử lý trả nợ dùng chung mọi loại công nợ) không đồng bộ ngược lại `import_orders` khi khoản nợ có liên kết `stock_entry`. Chưa sửa vì cần chạm vào lõi xử lý thanh toán chung — **hỏi user muốn: (a) chỉ sửa lại đúng bản ghi NK-0075 hiện tại (nhanh, an toàn, không sửa lỗi tận gốc), hay (b) sửa `PaymentIntentService` để tự đồng bộ mọi lần trả nợ NCC có liên kết phiếu nhập kho về sau (đúng gốc nhưng đụng vào code dùng chung, cần test kỹ hơn)**.
