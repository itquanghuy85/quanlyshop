...
**Build Status:** ✅ `flutter build apk --debug` OK, đã cài + test trên Oppo CPH2203 (`m@m.com`/shop "M") — xem `[2026-08-29c]`, `[2026-08-29b]`, `[2026-08-29a]`, `[2026-08-24q]`, `[2026-08-24p]`, `[2026-08-24o]`, `[2026-08-24n]`, `[2026-08-24m]`, `[2026-08-24l]`, `[2026-08-24k]`, `[2026-08-24j]`, `[2026-08-24i]`, `[2026-08-24h]`, `[2026-08-24g]`, `[2026-08-24f]`, `[2026-08-24e]`, `[2026-08-24d]`, `[2026-08-24c]`, `[2026-08-24b]`, `[2026-08-24a]`, `[2026-08-23d]`, `[2026-08-23c]`, `[2026-08-23b]`, `[2026-08-23a]`, `[2026-08-22a]`  
...
**🐛 TASK RIÊNG — chưa xử lý (ghi nhận theo yêu cầu user):** `CategoryService.getShopSettings` → INSERT `shop_settings` fail `UNIQUE constraint failed: shop_settings.firestoreId` → clear cache → lặp, giữ DB locked ~10s nhiều lần lúc cold-start (lần đầu sau cài mới Home mất ~45s). Không do các thay đổi 2026-08-29. **Cần task riêng: đổi INSERT → upsert cho `shop_settings`.**
