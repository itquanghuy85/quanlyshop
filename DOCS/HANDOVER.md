...
&nbsp;&nbsp;&nbsp;&nbsp;- **Còn:** 3.5 (`home_view` — rename biến `netProfit`→`netCashToday`, nhãn "DÒNG TIỀN RÒNG HÔM NAY", donut "Bán hàng/Sửa chữa"→"Tiền bán/Tiền sửa"). 3.6 report-only: nhánh trả góp trong `analyze()` chưa accrual thuần.
