...
**Build Status:** ✅ `flutter build apk --debug` OK, đã cài + test trên Oppo CPH2203 (`m@m.com`/shop "M") — xem `[2026-08-29i]`, `[2026-08-29h]`, `[2026-08-29g]`, `[2026-08-29f]`, `[2026-08-29e]`, `[2026-08-29d]`, `[2026-08-29c]`, `[2026-08-29b]`, `[2026-08-29a]`, `[2026-08-24q]`, `[2026-08-24p]`, `[2026-08-24o]`, `[2026-08-24n]`, `[2026-08-24m]`, `[2026-08-24l]`, `[2026-08-24k]`, `[2026-08-24j]`, `[2026-08-24i]`, `[2026-08-24h]`, `[2026-08-24g]`, `[2026-08-24f]`, `[2026-08-24e]`, `[2026-08-24d]`, `[2026-08-24c]`, `[2026-08-24b]`, `[2026-08-24a]`, `[2026-08-23d]`, `[2026-08-23c]`, `[2026-08-23b]`, `[2026-08-23a]`, `[2026-08-22a]`  
...
&nbsp;&nbsp;• **➡️ PHASE 2 (chờ user chốt mô hình kế toán trước khi code):** accrual (DailyFinancialAnalysis) vs cash basis (FinanceV2) cho doanh thu/COGS/lợi nhuận — nguyên tắc user: doanh thu KHÔNG phụ thuộc đã thu tiền; bỏ cap COGS `min(cost, paid)` (đang giấu lỗ, vd sale giá 50k/vốn 100k); `financial_activity_log.balanceAfter*` toàn NULL (chốt là audit-log hay source-of-truth). Ngoài ra: `repair_partner_payments` mồ côi khi VOID repair (thiếu FK repair↔payment); `sale_detail_view._deleteSale` hard-delete local (cân nhắc soft-delete cho nhất quán `DataReconciliationService`); VOID đơn đã thu tiền thật có sinh bút toán hoàn tiền không.
