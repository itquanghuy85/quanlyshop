...
**Build Status:** ✅ `flutter build apk --debug` OK, đã cài + test trên Oppo CPH2203 (`m@m.com`/shop "M") — xem `[2026-08-24q]`, `[2026-08-24p]`, `[2026-08-24o]`, `[2026-08-24n]`, `[2026-08-24m]`, `[2026-08-24l]`, `[2026-08-24k]`, `[2026-08-24j]`, `[2026-08-24i]`, `[2026-08-24h]`, `[2026-08-24g]`, `[2026-08-24f]`, `[2026-08-24e]`, `[2026-08-24d]`, `[2026-08-24c]`, `[2026-08-24b]`, `[2026-08-24a]`, `[2026-08-23d]`, `[2026-08-23c]`, `[2026-08-23b]`, `[2026-08-23a]`, `[2026-08-22a]`  
...
**Branch:** master  
**⚠️ Đã làm, CHƯA test trọn vẹn trên máy thật (2026-08-24q):** gộp 14 chỗ tự tay tạo công nợ mới (rải ở 7 file — nhập kho/sửa chữa/kho phụ tùng) về 1 hàm chung `PaymentIntentService.createDebtRecord`. Nhân tiện sửa 2 lỗi thật phát hiện được: `repair_detail_view.dart` có 1 chỗ dùng sai `status='UNPAID'` (chuẩn là 'ACTIVE') + thiếu đồng bộ Firestore; `inventory_view.dart` nhánh tiền mặt/chuyển khoản cũng thiếu đồng bộ Firestore. `flutter analyze` sạch + build thành công + dialog mở lại không crash, nhưng **chưa xác nhận được thao tác Lưu cuối cùng trên máy thật** (bàn phím ảo vướng thao tác tự động, đã dừng theo yêu cầu tiết kiệm token của user). **Cần user tự thử 1 lần**: tạo công nợ CÔNG NỢ qua 1 trong các luồng (vd Kho > Danh sách sản phẩm > sửa 1 sản phẩm "Chưa vốn" > chọn CÔNG NỢ > Lưu), rồi kiểm tra công nợ hiện đúng ở màn Công nợ + đã đồng bộ. Chi tiết: `docs/CHANGELOG.md` mục `[2026-08-24q]`.
