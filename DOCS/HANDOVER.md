...
**Version:** 3.5.0+548 (đóng gói lên store — `[2026-08-29e..r]`; 3.4.0+545 đang live). AAB build lại ở +548 để gồm fix bàn phím che ô nhập `[2026-08-29r]` (các build +546/+547 chưa upload store → bỏ, dùng +548).  
