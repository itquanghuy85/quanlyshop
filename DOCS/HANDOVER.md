...
**Version:** 3.5.0+546 (đóng gói lên store — bản vá HỆ THỐNG TÀI CHÍNH `[2026-08-29e..q]`; 3.4.0+545 đang live). ⚠️ `[2026-08-29q]` thêm SAU khi build AAB — nếu chưa upload store thì build lại AAB để gồm fix trả góp; nếu đã upload thì fix này vào bản kế tiếp.  
