...
**Version:** 3.5.0+547 (đóng gói lên store — bản vá HỆ THỐNG TÀI CHÍNH `[2026-08-29e..q]`; 3.4.0+545 đang live). AAB build lại ở +547 để gồm fix trả góp `[2026-08-29q]` (build +546 trước đó chưa upload, bỏ).  
