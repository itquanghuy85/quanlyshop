...
**Version:** 3.5.0+549 (đóng gói lên store — `[2026-08-29e..s]`; 3.4.0+545 đang live). AAB build lại ở +549 để gồm đợt LÀM DỨT ĐIỂM AUDIT tài chính `[2026-08-29s]` (L-1..L-4 + D-1..D-4). Các build +546/+547/+548 chưa upload store → bỏ, dùng +549.  
