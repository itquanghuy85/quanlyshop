...
**Build Status:** ✅ `flutter build apk --debug` OK — **CHƯA cài lên máy thật** (không có thiết bị/adb kết nối trong phiên 2026-08-22)  
...
### 🔴 Vừa hoàn thành (2026-08-22a): feat(sale,debt) công nợ khách hàng gộp nhiều đơn (bán sỉ) + thu tiền phân bổ FIFO — CHƯA TEST MÁY THẬT
...
- `flutter analyze` sạch toàn project (0 error) sau từng bước, `flutter build apk --debug` thành công. **CHƯA cài lên máy thật, CHƯA tự tay chạy qua bất kỳ luồng nghiệp vụ nào** — không có thiết bị/adb trong phiên này. Đây là feature lớn, đụng tới migration DB và luồng tiền — **bắt buộc user tự test kỹ trên máy thật trước khi cho nhân viên dùng**, đặc biệt: máy có dữ liệu cũ mở lên có tự chạy migration v106 đúng không, tạo nhiều đơn công nợ cho 1 khách rồi thu gộp có tính đúng không, doanh thu có bị tăng sai khi thu công nợ không
