# super_admin_console_view

Nguồn code: lib/views/super_admin_console_view.dart
...
- Widget chính: SuperAdminConsoleView, _DashboardSection, _ShopsSection, _ShopUsersTab, _ShopActivityTab, _UsersSection, _PermissionsSection, _AuditSection, _SettingsSection, _DangerSection
...
- navPush=0, FAB=False, Dialog=False, BottomSheet=True, ListOrGrid=True.
