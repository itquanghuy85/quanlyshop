# customer_loyalty_view

Nguồn code: lib/views/expansion/crm/customer_loyalty_view.dart

## 1. Purpose
- Miền nghiệp vụ: CRM & Giao tiếp.
...
- Widget chính: CustomerLoyaltyView
...
- Quan hệ: màn hình nằm trong cụm CRM & Giao tiếp và gắn với service domain tương ứng.
...
- navPush=1, FAB=False, Dialog=False, BottomSheet=False, ListOrGrid=True.
