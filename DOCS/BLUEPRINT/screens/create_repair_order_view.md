...
Nguồn code: lib/views/create_repair_order_view.dart
...
- Widget chính: CreateRepairOrderView, CustomerSelectionDialog
...
- Điều hướng nội bộ: file có khoảng 2 điểm Navigator.push, cho thấy mức độ điều phối đa màn hình.
...
- navPush=2, FAB=False, Dialog=True, BottomSheet=True, ListOrGrid=True.
