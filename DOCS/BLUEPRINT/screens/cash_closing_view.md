...
Nguồn code: lib/views/cash_closing_view.dart

## 1. Purpose
- Miền nghiệp vụ: Tài chính & Công nợ.
...
- Quan hệ: màn hình nằm trong cụm Tài chính & Công nợ và gắn với service domain tương ứng.
