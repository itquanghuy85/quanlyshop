# shop_deduction_settings_view

Nguồn code: lib/views/hr/shop_deduction_settings_view.dart
...
- Widget chính: ShopDeductionSettingsView, _CurrencyField, _PercentField, _NumberField
