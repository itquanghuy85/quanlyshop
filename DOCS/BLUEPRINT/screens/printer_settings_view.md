# printer_settings_view

Nguồn code: lib/views/printer_settings_view.dart
...
- Widget chính: PrinterSettingsView
...
- navPush=5, FAB=False, Dialog=True, BottomSheet=False, ListOrGrid=True.
