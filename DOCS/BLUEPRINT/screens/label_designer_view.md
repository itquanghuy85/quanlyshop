...
Nguồn code: lib/views/label_designer_view.dart
...
- Widget chính: LabelDesignerView
- Tín hiệu cấu trúc: list/grid = False, FAB = True, dialog = True, bottom sheet = False.
...
- navPush=1, FAB=True, Dialog=True, BottomSheet=False, ListOrGrid=False.
