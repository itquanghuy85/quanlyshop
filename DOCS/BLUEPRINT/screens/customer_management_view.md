...
Nguồn code: lib/views/customer_management_view.dart
...
- Widget chính: CustomerManagementView, CustomerListItem, CustomerFormDialog, CustomerHistoryDialog
...
- navPush=1, FAB=False, Dialog=True, BottomSheet=False, ListOrGrid=True.
