...
Nguồn code: lib/views/login_view.dart

## 1. Purpose
- Miền nghiệp vụ: Xác thực & Khởi tạo.
...
- Widget chính: LoginView
- Tín hiệu cấu trúc: list/grid = False, FAB = False, dialog = True, bottom sheet = False.
...
- Quan hệ: màn hình nằm trong cụm Xác thực & Khởi tạo và gắn với service domain tương ứng.
...
- navPush=1, FAB=False, Dialog=True, BottomSheet=False, ListOrGrid=False.
