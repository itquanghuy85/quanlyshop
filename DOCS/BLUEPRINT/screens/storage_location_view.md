# storage_location_view

Nguồn code: lib/views/storage_location_view.dart
...
- Widget chính: StorageLocationView, _MenuRow, _LocationProductsSheet, _LocationFormDialog
- Tín hiệu cấu trúc: list/grid = True, FAB = True, dialog = False, bottom sheet = True.
...
- navPush=0, FAB=True, Dialog=False, BottomSheet=True, ListOrGrid=True.
