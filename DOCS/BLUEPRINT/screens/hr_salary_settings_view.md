...
Nguồn code: lib/views/hr_salary_settings_view.dart
...
- Widget chính: HRSalarySettingsView, _CurrencyFieldWidget, _PercentFieldWidget, _NumberFieldWidget
...
- navPush=0, FAB=False, Dialog=False, BottomSheet=False, ListOrGrid=True.
