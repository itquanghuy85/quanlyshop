...
Nguồn code: lib/views/expansion/branch/branch_list_view.dart

## 1. Purpose
- Miền nghiệp vụ: Expansion Modules.
...
- Quan hệ: màn hình nằm trong cụm Expansion Modules và gắn với service domain tương ứng.
