# staff_public_profile_view

Nguồn code: lib/views/staff_public_profile_view.dart

## 1. Purpose
- Miền nghiệp vụ: Nhân sự.
...
- Widget chính: StaffPublicProfileView
- Tín hiệu cấu trúc: list/grid = False, FAB = False, dialog = False, bottom sheet = False.
...
- Quan hệ: màn hình nằm trong cụm Nhân sự và gắn với service domain tương ứng.
...
- navPush=2, FAB=False, Dialog=False, BottomSheet=False, ListOrGrid=False.
