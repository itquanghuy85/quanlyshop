...
Nguồn code: lib/views/supplier_list_view.dart
...
- Điều hướng nội bộ: file có khoảng 6 điểm Navigator.push, cho thấy mức độ điều phối đa màn hình.
...
- navPush=6, FAB=True, Dialog=True, BottomSheet=False, ListOrGrid=True.
