# staff_self_profile_view

Nguồn code: lib/views/staff_self_profile_view.dart
...
- Widget chính: StaffSelfProfileView
...
- navPush=2, FAB=False, Dialog=False, BottomSheet=True, ListOrGrid=True.
