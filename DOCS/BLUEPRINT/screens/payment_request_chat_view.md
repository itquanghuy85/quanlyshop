# payment_request_chat_view

Nguồn code: lib/views/payment_request_chat_view.dart

## 1. Purpose
- Miền nghiệp vụ: Bán hàng & Thu tiền.
...
- Widget chính: PaymentRequestChatView, _CreatePaymentRequestSheet, _CustomerSearchDialog
- Tín hiệu cấu trúc: list/grid = True, FAB = False, dialog = False, bottom sheet = True.
...
- Điều hướng nội bộ: file có khoảng 1 điểm Navigator.push, cho thấy mức độ điều phối đa màn hình.
...
- Quan hệ: màn hình nằm trong cụm Bán hàng & Thu tiền và gắn với service domain tương ứng.
...
- navPush=1, FAB=False, Dialog=False, BottomSheet=True, ListOrGrid=True.
