...
Nguồn code: lib/views/smart_stock_in_view.dart
...
- Widget chính: SmartStockInView, _IMEIScannerDialog
...
- navPush=2, FAB=False, Dialog=False, BottomSheet=False, ListOrGrid=True.
