# partner_management_view

Nguồn code: lib/views/partner_management_view.dart
...
- Widget chính: PartnerManagementView
...
- navPush=2, FAB=True, Dialog=True, BottomSheet=False, ListOrGrid=True.
