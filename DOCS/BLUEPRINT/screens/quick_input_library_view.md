# quick_input_library_view

Nguồn code: lib/views/quick_input_library_view.dart

## 1. Purpose
- Miền nghiệp vụ: Tổng hợp vận hành.
...
- Widget chính: QuickInputLibraryView, _QuickInputCodeDialog
...
- Quan hệ: màn hình nằm trong cụm Tổng hợp vận hành và gắn với service domain tương ứng.
...
- navPush=1, FAB=True, Dialog=True, BottomSheet=False, ListOrGrid=True.
