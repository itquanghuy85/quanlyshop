...
Nguồn code: lib/views/create_sale_view.dart
...
- Widget chính: CreateSaleView, CustomerSelectionDialog, _GiftDiscountSheetContent
- Tín hiệu cấu trúc: list/grid = True, FAB = False, dialog = False, bottom sheet = False.
...
- Điều hướng nội bộ: file có khoảng 3 điểm Navigator.push, cho thấy mức độ điều phối đa màn hình.
...
- navPush=3, FAB=False, Dialog=False, BottomSheet=False, ListOrGrid=True.
