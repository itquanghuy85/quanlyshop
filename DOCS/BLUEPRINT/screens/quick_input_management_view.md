# quick_input_management_view

Nguồn code: lib/views/quick_input_management_view.dart
...
- Widget chính: QuickInputManagementView
- Tín hiệu cấu trúc: list/grid = True, FAB = True, dialog = False, bottom sheet = False.
...
- navPush=1, FAB=True, Dialog=False, BottomSheet=False, ListOrGrid=True.
