# variant_management_view

Nguồn code: lib/views/fashion/variant_management_view.dart
...
- Widget chính: VariantManagementView, _ProductSelectorSheet, _AddVariantDialog, _EditVariantDialog, _BulkImportDialog, _PrintBarcodeDialog
...
- navPush=0, FAB=True, Dialog=False, BottomSheet=False, ListOrGrid=True.
