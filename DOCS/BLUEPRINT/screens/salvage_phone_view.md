...
Nguồn code: lib/views/salvage_phone_view.dart
...
- Widget chính: SalvagePhoneView
- Tín hiệu cấu trúc: list/grid = True, FAB = True, dialog = True, bottom sheet = True.
...
- navPush=0, FAB=True, Dialog=True, BottomSheet=True, ListOrGrid=True.
