# business_type_wizard

Nguồn code: lib/views/onboarding/business_type_wizard.dart
...
- Widget chính: BusinessTypeWizard, BusinessTypeQuickSelector
...
- navPush=0, FAB=False, Dialog=False, BottomSheet=False, ListOrGrid=False.
