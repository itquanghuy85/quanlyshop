          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              return ListTile(
                ...
                trailing: Text(_themeService.getThemeModeName()),
                onTap: () => _showThemeDialog(),
              );
            },
          ),
          ListTile(
            leading: ConnectivityBadge(),
            title: const Text("Trạng thái kết nối"),
            trailing: Text(
              ConnectivityService.instance.isOnline ? "Online" : "Offline",
              style: TextStyle(
                color: ConnectivityService.instance.isOnline ? Colors.green : Colors.red,
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              trailing: _themeService.isLightMode ? const Icon(Icons.check, color: Colors.blue) : null,
              onTap: () {
            ...
            ListTile(
              ...
              trailing: _themeService.isDarkMode ? const Icon(Icons.check, color: Colors.blue) : null,
              onTap: () {
            ...
            ListTile(
              ...
              trailing: _themeService.isSystemMode ? const Icon(Icons.check, color: Colors.blue) : null,
              onTap: () {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            ...status.map((result) => Text('• ${result.name}')),
            const SizedBox(height: 16),
            Text(
              isOnline
                  ? 'Ứng dụng đang hoạt động bình thường với đồng bộ dữ liệu real-time.'
                  : 'Ứng dụng đang ở chế độ offline. Một số tính năng có thể bị hạn chế.',
