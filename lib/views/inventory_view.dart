...
<<<<<<< HEAD
          IconButton(
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => QuickInputCodesView())),
...
<<<<<<< HEAD
                ...
                Expanded(
                  child: Stack(
                    children: [
                      ElevatedButton.icon(
                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => QuickInputCodesView())).then((_) => _refresh()),
