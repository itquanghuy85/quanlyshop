...
<<<<<<< HEAD
              child: Text("THU TIỀN TRẢ NỢ", style: TextStyle(color: Theme.of(context).colorScheme.onPrimary, fontWeight: FontWeight.bold)),
=======
...
<<<<<<< HEAD
              if (payAmount == null || payAmount! <= 0) {
                NotificationService.showSnackBar("Vui lòng nhập số tiền hợp lệ!", color: Colors.red);
                return;
              }
=======
...
=======
    int totalRemain = list.fold(0, (sum, d) => sum + (d['totalAmount'] as int) - (d['paidAmount'] as int? ?? 0));
>>>>>>> b5bd6ff7fc4a5fad82eac68e9a8c1a891e5415b6
...
<<<<<<< HEAD
  ...
  void _createOtherDebt() {
    ...
    int? debtAmount; // Lưu giá trị đã nhân 1000 từ widget
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              ThousandCurrencyTextField(
                ...
                label: "Số tiền nợ",
                required: true,
                onCompleted: (value) => debtAmount = value,
              ),
              const SizedBox(height: 10),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                if (nameC.text.isEmpty || debtAmount == null || debtAmount! <= 0) {
                  NotificationService.showSnackBar("Vui lòng nhập đầy đủ thông tin!", color: Colors.red);
                  return;
                }
