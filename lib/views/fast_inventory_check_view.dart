  ...
  void _showResults() {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('KẾT QUẢ KIỂM KHO'),
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text('• Đã kiểm: ${phoneResults['checked']}'),
              Text('• Thiếu: ${phoneResults['missing']}'),
              Text('• Thừa: ${phoneResults['extra']}'),
              const SizedBox(height: 16),
              Text('🔧 PHỤ KIỆN:', style: TextStyle(fontWeight: FontWeight.bold)),
              Text('• Đã kiểm: ${accessoryResults['checked']}'),
              Text('• Thiếu: ${accessoryResults['missing']}'),
              Text('• Thừa: ${accessoryResults['extra']}'),
              const SizedBox(height: 16),
              Text('📊 TỔNG QUAN:', style: TextStyle(fontWeight: FontWeight.bold)),
              Text('• Tổng scan: $_totalScanned'),
            ],
          ),
        ),
        actions: [
