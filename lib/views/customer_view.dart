          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(child: Text("${c['customerName']}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.blueAccent))),
                  Text("${NumberFormat('#,###').format(c['totalSpent'])} đ", style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold)),
                ],
              ),
