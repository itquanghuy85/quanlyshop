...
class CategoryService {
  ...
  // [2026-09-12] Đã gỡ toàn bộ CRUD "Danh mục sản phẩm" (getCategories /
  // addCategory / updateCategory / deleteCategory / initializeDefaultCategories
  // …): màn Quản lý danh mục là cái vỏ chưa nối dây — không màn nào gán
  // `products.categoryId`, kho/bán hàng vẫn phân loại bằng `type` cứng
  // (DIEN_THOAI / PHU_KIEN / LINH_KIEN). Service này nay chỉ còn lo
  // ShopSettings; giữ tên class để không đụng 26 chỗ gọi getShopSettings().
}
